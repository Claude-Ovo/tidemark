...
const fragmentShader = /* glsl */`
  ...
  void main() {
    ...
    vec3 color = uDeepBlue * mix(0.16, 0.34, depthHint);
    float alpha = uBaseAlpha * mix(0.62, 1.0, depthHint);
...
export const createWaterDisk = ({
  ...
  return {
    ...
    metrics() { return { mode: 'minimal-transparent-base', baseAlpha: uniforms.uBaseAlpha.value } },
    dispose() {
      geometry.dispose()
      material.dispose()
    },
